...
/* harmony default export */ __webpack_exports__["default"] = ("<mat-sidenav-container [hasBackdrop]=\"false\">\n  <mat-sidenav\n    class=\"pt-4\"\n    #sidenav\n    [opened]=\"true\"\n    [mode]=\"'side'\"\n    [fixedInViewport]=\"true\"\n  >\n    <div class=\"container-fluid\">\n      <div class=\"row\">\n        <div class=\"col-sm-12\">\n          <label>Presets:</label>\n          <select\n            class=\"form-control\"\n            [(ngModel)]=\"pIndex\"\n            [disabled]=\"customPattern.length > 0\"\n          >\n            <option value=\"0\">Ikea (vcvv)</option>\n            <option value=\"1\">Saab (cvvc)</option>\n            <option value=\"2\">Assa (vccv)</option>\n            <option value=\"3\">Kivra (cvccv)</option>\n            <option value=\"4\">Klarna (ccvccv)</option>\n            <option value=\"5\">RANDOM!</option>\n          </select>\n          <label>Number of words:</label>\n          <div class=\"text-center\">\n            <mat-slider\n              [(ngModel)]=\"numOfWords\"\n              [max]=\"1000\"\n              [min]=\"100\"\n              [step]=\"100\"\n              [value]=\"100\"\n            ></mat-slider\n            >{{ numOfWords }}\n          </div>\n          <label>Only unique letters:</label>\n          <div>\n            <mat-slide-toggle [(ngModel)]=\"noRepeat\"></mat-slide-toggle>\n          </div>\n          <label>Pattern:</label>\n          <input type=\"text\" class=\"form-control\" [(ngModel)]=\"customPattern\" />\n          <hr />\n          <button\n            class=\"btn btn-primary\"\n            (click)=\"randomize()\"\n            [disabled]=\"\n              customPattern.length > 0 &&\n              customPattern.indexOf('*') === -1 &&\n              customPattern.indexOf('C') === -1 &&\n              customPattern.indexOf('V') === -1\n            \"\n          >\n            Generate!\n          </button>\n        </div>\n      </div>\n    </div>\n  </mat-sidenav>\n  <mat-sidenav-content>\n    <div class=\"container-fluid\">\n      <div class=\"row\">\n        <div class=\"col-sm-12 pt-3\">\n          <h2 class=\"mt-2 d-inline-block text-warning\" (click)=\"sidenav.open()\">\n            <img src=\"./../assets/swedish_flag.svg\" /> Swedish company name\n            generator\n          </h2>\n          <p (click)=\"sidenav.close()\">\n            Welcome to the swedish company name generator! Here in Sweden, we\n            love short names like volvo, ikea, klarna, kivra etc. 4 or 5 letter.\n            Doesn't the name mean anything? Even Better! Go ahead and generate\n            your own swedish company name.\n          </p>\n          <div\n            *ngIf=\"error != ''\"\n            class=\"alert alert-danger-custom animated flash\"\n            role=\"alert\"\n          >\n            {{ error }}\n          </div>\n        </div>\n\n        <ng-container *ngIf=\"words.length > 0\">\n          <div class=\"col-sm-4\" *ngFor=\"let word of words\">\n            {{ word }}\n          </div>\n        </ng-container>\n      </div>\n    </div>\n  </mat-sidenav-content>\n</mat-sidenav-container>\n");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = (".container {\n  padding-top: 2rem;\n}\n\nh2 img {\n  float: left;\n  margin-right: 0.5rem;\n  width: 68px;\n}\n\n.alert-danger-custom {\n  background-color: #e41111;\n  color: white;\n}\n\n/*# sourceMappingURL=data:application/json;base64, */");
...
let AppComponent = class AppComponent {
    constructor() {
        this.title = 'The Swedish company name generator';
        this.words = [];
        // 0 = consonant, 1 = vowel
        this.patterns = [
            'VCVV',
...
module.exports = __webpack_require__(/*! /Users/mikaeljuntti/repos/scng/src/main.ts */"./src/main.ts");
